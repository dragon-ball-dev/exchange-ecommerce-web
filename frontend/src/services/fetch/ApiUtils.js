...
export function getAllShop(pageNo, pageSize, name, size, price) {

    return request({
        url: API_BASE_URL + "/product/find-product?name="+name+"&price="+price+"&size="+size+"&page="+(pageNo - 1)+"&sizePage="+pageSize,
        method: 'GET'
    });
}