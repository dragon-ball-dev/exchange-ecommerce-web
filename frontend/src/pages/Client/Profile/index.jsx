    ...
    return (
        <div>
            <div className="flex flex-col relative">
                <div className="items-stretch bg-green-100 flex flex-col w-full ">
                    <img
                        loading="lazy"
                ...
                <div className="items-center border border-solid self-center mb-[20px] shadow-sm bg-white z-[1] flex mt-0 w-[1028px] max-w-full flex-col pb-4 rounded-2xl">
                                ...
                                <div className="flex grow flex-col items-stretch max-md:max-w-full max-md:mt-8">
                                    <div className="flex justify-between gap-5 max-md:max-w-full max-md:flex-wrap">
                                        <div className="items-stretch flex grow basis-[0%] flex-col mt-6">
                                            <div className="text-gray-800 text-2xl font-bold leading-8 whitespace-nowrap">
                                                Minh Sơn Nguyễn
                                            </div>
                                            <div className="text-gray-500 text-2xl font-bold leading-6 whitespace-nowrap">
                                                @nms1010
                                            </div>
                                        </div>
                                        <img
                                        ...
                                        <div className="items-stretch flex justify-between gap-2.5">
                                            <div className="items-stretch bg-violet-50 flex grow basis-[0%] flex-col pl-3 pr-11 py-3 rounded-2xl max-md:pr-5">
                                                <div className="items-stretch flex justify-between gap-1.5">
                                                    ...
                                                    />
                                                    <div className="text-black text-sm font-bold leading-4 self-center whitespace-nowrap my-auto">
                                                        Meeting spots
                                                    </div>
                                                </div>
                                                <div className="text-gray-500 text-sm font-bold leading-4 whitespace-nowrap">
                                                    Not selected
                                                </div>
                                            </div>
                                        ...
                                        <div className="items-stretch self-center flex justify-between gap-5 my-auto max-md:justify-center">
                                            <div className="items-stretch flex gap-0.5 py-px max-md:justify-center">
                                                ...
                                                <div className="items-center flex grow basis-[0%] flex-col">
                                                    <div className="text-gray-800 text-center text-lg font-bold leading-7 whitespace-nowrap">
                                                        0
                                                    </div>
                                                    <div className="text-gray-500 text-center text-2xl font-bold leading-6 self-stretch whitespace-nowrap">
                                                        trades
                                                    </div>
                                                </div>
                                                <img
                                            ...
                                            <div className="items-center flex grow basis-[0%] flex-col">
                                                <div className="text-black text-center text-lg font-bold leading-7 whitespace-nowrap">
                                                    0
                                                </div>
                                                <div className="text-gray-500 text-center text-2xl font-bold leading-6 self-stretch whitespace-nowrap">
                                                    followers
                    ...
                    <div className="justify-between items-stretch flex w-[171px] max-w-full gap-5 ml-8 mt-4 self-start max-md:ml-2.5">
                        <div className="text-white text-2xl font-bold leading-6 whitespace-nowrap items-stretch bg-indigo-600 aspect-[2.0285714285714285] px-4 py-1.5 rounded-[50px]">
                            <a href="https://bunz.com/profile/nms1010" target="_blank">
                                Posts
                            </a>
                        </div>
                        <div className="text-gray-800 text-2xl font-bold leading-6 self-center whitespace-nowrap my-auto">
                            <a href="https://bunz.com/profile/nms1010/reviews" target="_blank">
                                Reviews
                            </a>
                        </div>
                    </div>
                ...
                <div className="items-center  border border-solid mb-[50px] self-center shadow-sm bg-white z-[1] flex w-[1028px] max-w-full flex-col pb-4 rounded-2xl">
                    ...
                    />
                    <div className="text-gray-800 text-2xl font-bold leading-6 self-center whitespace-nowrap mt-9">
