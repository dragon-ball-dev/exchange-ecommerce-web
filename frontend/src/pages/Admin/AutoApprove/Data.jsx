...
import AutoApproveDetail from './AutoApproveDetail';
...
function Data() {
            ...
            action: (
                <div className="flex gap-3">
                    ...
                    {/* <Button
                        ...
                        // onClick={() => navigate(`${config.routes.admin.AutoApprove}/1`)}
                    >
    ...
    return (
        <div>
            ...
            />
            <AutoApproveDetail isDetailOpen={isDetailOpen} setIsDetailOpen={setIsDetailOpen} />
            <ConfirmPrompt
