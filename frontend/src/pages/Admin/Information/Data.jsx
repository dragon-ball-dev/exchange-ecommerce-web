...
function Data() {
            ...
            action: (
                <div className="flex gap-3">
                    ...
                    <Button
                        ...
                        // onClick={() => navigate(`${config.routes.admin.Information}/1`)}
                    >
    ...
    return (
        <div>
            ...
            />
            <InformationDetail isDetailOpen={isDetailOpen} setIsDetailOpen={setIsDetailOpen} />
            <ConfirmPrompt
                content="Bạn có muốn ẩn thông tin này ?"
