                        ...
                        <div className="col-md-6 contents">
                            <div className="row justify-content-center">
                                <div className="col-md-8">
                                    <div className="mb-4">
                                        <h3>Sign In <a href="/" style={{ textDecoration: 'none' }}><img src="../../assets/img/logo.png" alt="" /></a></h3>
                                        <p className="mb-4">If you don't account. <a href="/signup">Sign up a new account.</a></p>
                                    </div>
                                    <LoginForm />
...
function LoginForm() {
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <input type="submit" value="Sign In" className="btn text-white btn-block" style={{ background: "#38d39f" }} />
        </form>
    )
}
