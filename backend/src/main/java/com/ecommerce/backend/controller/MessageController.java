...
import com.ecommerce.backend.repository.MessageChatRepository;
...
import com.ecommerce.backend.services.impl.MessageServiceImpl;
...
public class MessageController {
    ...
    public Message testSendMessage() {
		...
		String email1 = "tranvanchung1409@gmail.com", email2 = "tranvanchung14@gmail.com";
		...
		messageChat.setContent("test tinh nanggggg!!!");
...
//	@PreAuthorize("hasRole('USER') or hasRole('RENTALER')")
    public List<User> findMessageUser(@CurrentUser UserPrincipal userPrincipal, @PathVariable Long id) {
        return userServiceImpl.findMessageUser(id);
    }
